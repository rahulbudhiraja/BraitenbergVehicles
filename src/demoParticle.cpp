...
//      cout << "steer"<< steer ;
    ...
    /*
     ...
     float m = ofMap(d,2500,600,maxspeed/6,maxspeed/4);
     m = ofMap(d,600,300,maxspeed/4,maxspeed/2);
     m = ofMap(d,300,200,maxspeed/2,maxspeed);

     maxforce = ofMap(d,1200,1000,0,.001);
...
//        target.set (ofGetMouseX(), ofGetMouseY());
        ...
        if (d < 1200 && d > 30) {
            ...
            float m = ofMap(d,1200,600,1.2*maxspeed,1.3* maxspeed);
            ...
            //float m = ofMap(d,1200,1500,maxspeed/3,maxspeed/10);
            maxforce = ofMap(d ,1200,1500,0,0);


            float m = ofMap(d,1200,1500,0.001, 0.001);
            desired *=m;
